...
baiying-server exposes public client banner endpoints for the desktop sidebar invitation ad. As of 2026-07-03, the desktop client should use the list endpoint and rotate multiple active banners in the left-bottom sidebar slot.
  ...
  "data": [
    {
      ...
      "weight": 1,
      "status": 1,
      "linkUrl": "https://baiying.youdao.com/portal#/invitation",
