...
- optional `_baiying_assets/*` image files
- optional `_baiying_share_manifest.json`
...
- Package Markdown as entry Markdown plus local relative image assets under `_baiying_assets/`.
