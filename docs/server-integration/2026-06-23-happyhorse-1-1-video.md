...
baiying-server adds one logical admin-configured video model, `HappyHorse-1.1`, backed by three Aliyun HappyHorse 1.1 upstream submodels. The server chooses the concrete upstream model dynamically from image input count:
