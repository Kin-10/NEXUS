...
`baiying-server` now distinguishes HTML shares closed by the active share limit from shares closed by users, admins, moderation, or other system reasons.
...
```json
{
  ...
  "data": {
    ...
    "url": "https://baiying.youdaosmart.com/s/shr_xxxxxxxxxxxxxxxx/",
    "accessMode": "code",
    "status": "disabled",
