...
The dedicated host lets user apps keep root-relative API paths and cookies scoped to their own share host. This avoids collisions with BaiYing server APIs such as `/api/*`.
