...
This guide walks through testing the entire Web Search Skill integration with BaiYing.

## Prerequisites

1. BaiYing built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with BaiYing.

**Steps:**

1. Start BaiYing in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of BaiYing launch.
...
1. Open a terminal while BaiYing is running
...
**Objective:** Verify graceful shutdown of services when BaiYing quits.

**Steps:**

1. With BaiYing running and searches completed, quit the application
...
1. Start BaiYing (ensure headless is false in config)
...
- ✅ Server auto-starts with BaiYing
