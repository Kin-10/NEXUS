...
This guide walks through testing the entire Web Search Skill integration with baiyingAI.

## Prerequisites

1. baiyingAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with baiyingAI.

**Steps:**

1. Start baiyingAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of baiyingAI launch.
...
1. Open a terminal while baiyingAI is running
...
**Objective:** Verify graceful shutdown of services when baiyingAI quits.

**Steps:**

1. With baiyingAI running and searches completed, quit the application
...
1. Start baiyingAI (ensure headless is false in config)
...
- ✅ Server auto-starts with baiyingAI
