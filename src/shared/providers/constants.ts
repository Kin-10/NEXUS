...
// ─── Provider Name ──────────────────────────────────────────────────────
// providerName identifies the BaiYing internal provider (config key).
...
const PROVIDER_DEFINITIONS = [
  ...
  },
  {
    ...
    openClawProviderId: OpenClawProviderId.hzbzhiyun,
    defaultBaseUrl: 'https://openapi.hzb.com/llmgateway/api/v1/chat/completions',
    defaultApiFormat: ApiFormat.OpenAI,
    codingPlanSupported: false,
    region: 'china',
  ...
  // ── Global ──
  {
    ...
    openClawProviderId: OpenClawProviderId.BaiyingCopilot,
