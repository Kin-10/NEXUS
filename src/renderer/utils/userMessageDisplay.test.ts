...
const WIN_INBOUND = String.raw`C:\Users\zhangsan\AppData\Roaming\BaiYing\openclaw\state\media\inbound`;
const MAC_INBOUND = '/Users/zhangsan/Library/Application Support/BaiYing/openclaw/state/media/inbound';
...
describe('BaiYing goal mode command display', () => {
