...
const serverModel: Model = { id: 'server-model', name: 'Server Model', providerKey: 'baiying-server', isServerModel: true };
...
const serverKimiModel: Model = { id: 'kimi-k2.6', name: 'Kimi K2.6', providerKey: 'baiying-server', isServerModel: true };
...
describe('selectAgentSelectedModel', () => {
  ...
  test('uses explicit server agent model ref over a same-id custom override', () => {
    ...
    const result = selectAgentSelectedModel(state, 'agent-1', 'baiying-server/kimi-k2.6');
  ...
  test('ignores explicit agent model refs that resolve to locked server models', () => {
    ...
    const result = selectAgentSelectedModel(state, 'agent-1', 'baiying-server/server-model');
