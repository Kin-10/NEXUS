import { supportsBaiYingRequestOptionsV1 } from '@shared/providers/baiYingRequestOptions';
import {
...
export function resolveModelThinkingLevel(
  ...
  if (!config || !supportsBaiYingRequestOptionsV1(model.requestCapabilities)) return undefined;
