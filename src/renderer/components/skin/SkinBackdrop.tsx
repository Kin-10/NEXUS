...
const HOME_OVERLAY = [
  ...
  'color-mix(in srgb, var(--baiying-background) 62%, transparent) 0%,',
  'color-mix(in srgb, var(--baiying-background) 44%, transparent) 47%,',
  'color-mix(in srgb, var(--baiying-background) 22%, transparent) 100%)',
  ', linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-background) 12%, transparent),',
  'color-mix(in srgb, var(--baiying-background) 54%, transparent))',
].join(' ');

const CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-background) 20%, transparent),',
  'color-mix(in srgb, var(--baiying-background) 36%, transparent))',
].join(' ');

const PRESENTED_HOME_OVERLAY = [
  'radial-gradient(ellipse at 50% 46%,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 52%, transparent) 0%,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 34%, transparent) 48%,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 18%, transparent) 100%)',
  ', linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 12%, transparent),',
  'color-mix(in srgb, var(--baiying-skin-canvas) 82%, transparent))',
].join(' ');

const PRESENTED_CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 44%, transparent),',
  'color-mix(in srgb, var(--baiying-skin-canvas) 62%, transparent))',
].join(' ');

const PRESENTED_DARK_CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 30%, transparent),',
  'color-mix(in srgb, var(--baiying-skin-canvas) 45%, transparent))',
].join(' ');

const PRESENTED_MANAGEMENT_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 32%, transparent),',
  'color-mix(in srgb, var(--baiying-skin-canvas) 46%, transparent))',
].join(' ');

const PRESENTED_DARK_MANAGEMENT_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--baiying-skin-canvas) 18%, transparent),',
  'color-mix(in srgb, var(--baiying-skin-canvas) 30%, transparent))',
].join(' ');
    ...
    >
      <img
        ...
        style={hasPresentation ? {
          objectPosition: 'var(--baiying-skin-focus-x) var(--baiying-skin-focus-y)',
        } : undefined}
