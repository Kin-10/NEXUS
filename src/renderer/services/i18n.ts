...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    settingsNavigationPersonal: '个人',
    settingsNavigationIntelligence: '智能与模型',
    settingsNavigationConnections: '连接与扩展',
    settingsNavigationSystem: '系统',
    general: '通用',
    model: '模型',
    ...
    coworkToolCapabilityName: '能力调用',
    coworkToolActivityGenerating: '正在努力生成中...',
    coworkToolActivityPolishingCode: '正在润色代码...',
    coworkToolActivityGatheringContext: '正在整理资料...',
    coworkToolActivityChecking: '正在检查结果...',
    coworkToolActivityPlanning: '正在整理计划...',
    coworkToolActivityDone: '调用完成',
    coworkToolInternalDetailHidden: '内部调用细节已隐藏',
    coworkToolInternalErrorHidden: '调用遇到问题，内部路径信息已隐藏',
  ...
  en: {
    ...
    settingsNavigationPersonal: 'Personal',
    settingsNavigationIntelligence: 'Intelligence & models',
    settingsNavigationConnections: 'Connections & extensions',
    settingsNavigationSystem: 'System',
    general: 'General',
    model: 'Model',
    ...
    coworkTaskWorkspace: 'Task workspace',
    ...
    coworkToolCapabilityName: 'Capability',
    coworkToolActivityGenerating: 'Working on the result...',
    coworkToolActivityPolishingCode: 'Polishing the code...',
    coworkToolActivityGatheringContext: 'Gathering context...',
    coworkToolActivityChecking: 'Checking the result...',
    coworkToolActivityPlanning: 'Organizing the plan...',
    coworkToolActivityDone: 'Call complete',
    coworkToolInternalDetailHidden: 'Internal call details are hidden',
    coworkToolInternalErrorHidden: 'The call hit an issue; internal path details are hidden',
