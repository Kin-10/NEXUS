...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 百应 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 百应 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutDescNewChat: '开始一个新的 百应 任务',
    shortcutDescFocusPrompt: '跳回 百应 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 百应 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 百应 Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    enterpriseQuotaMemberMemberDesc: '向团队管理员申请提高成员额度后继续使用百应。',
    enterpriseQuotaMemberAdminDesc: '调整额度后继续使用百应。',
    ...
    enterpriseQuotaPoolMemberDesc: '通知团队管理员购买团队积分包后继续使用百应。',
    enterpriseQuotaPoolAdminDesc: '购买团队积分包后，团队成员可继续使用百应。',
    ...
    coworkWorkingDirectoryHint: '百应 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 百应 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 百应 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '百应 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 百应 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 百应 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 百应 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 百应 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '百应 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '百应 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkWorkingStage2: '思路已经串起来了，继续推进…',
    coworkWorkingStage3: '埋头处理中，马上就有进展…',
    coworkWorkingStage4: '还在跟进细节，再稍等片刻…',
    coworkWorkingStage5: '事情比预想复杂一点，我继续盯着…',
    ...
    coworkHomeTagline: '我是 百应，你的全场景办公 Agent',
    ...
    coworkErrorModelSourceBaiYingPlan: '百应套餐',
    ...
    dshSettingsDesc: '内置 DeepSeek 官方开源 agent 框架（dsh）。启用后，百应 的模型供应商配置会自动同步给 dsh。',
    ...
    browserProfileManagedDescription: '百应 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为 百应 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '百应 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 百应 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 百应 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 百应 发送通知。',
    ...
    settingsNavGroupPreferences: '偏好',
    settingsNavGroupAgent: 'Agent',
    settingsNavGroupConnections: '连接',
    settingsNavGroupAbout: '关于',
    settingsNavSearchPlaceholder: '搜索设置…',
    settingsNavSearchEmpty: '未找到匹配的设置项',
    ...
    welcomeAgreementLinkText: '《网易有道百应服务协议》',
  ...
  en: {
    ...
    aiSkinDeleteManagedCopyNote: 'Only 百应-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the 百应 UI',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the 百应 window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutDescNewChat: 'Start a new 百应 task',
    shortcutDescFocusPrompt: 'Return to 百应 and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the 百应 task view',
    ...
    dailyCheckInLoginHint: 'Login is handled by 百应; the activity never receives account tokens',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit 百应 Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    enterpriseQuotaMemberMemberDesc: 'Request a higher member quota from your team administrator to continue using 百应.',
    enterpriseQuotaMemberAdminDesc: 'Adjust your quota to continue using 百应.',
    ...
    enterpriseQuotaPoolMemberDesc: 'Notify your team administrator to purchase a Team credit pack and continue using 百应.',
    enterpriseQuotaPoolAdminDesc: 'Purchase a Team credit pack so members can continue using 百应.',
    ...
    siteQuotaChooseHint: 'Choose an online site. 百应 will never stop one automatically.',
    ...
    artifactIntranetService: 'Intranet service',
    ...
    coworkWorkingDirectoryHint: '百应 will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 百应...',
    coworkSystemPromptHint: "Optional system prompt to customize 百应's behavior",
    ...
    coworkModelSettingsHint:
      '百应 uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up 百应 data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import 百应 data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import 百应 data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkConfigSaveFailed: 'Failed to save 百应 settings. Please try again.',
    ...
    coworkPermissionDescription: '百应 is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '百应 needs your input',
    ...
    coworkWorkingStage2: 'Thread coming together — pushing ahead…',
    coworkWorkingStage3: 'Heads down on it — progress coming shortly…',
    coworkWorkingStage4: 'Still working through the details…',
    coworkWorkingStage5: 'Taking longer than expected — staying on it…',
    ...
    coworkHomeTagline: "I'm 百应, your all-in-one office agent",
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add 百应 to your antivirus allowlist.',
    ...
    coworkErrorModelSourceBaiYingPlan: '百应 Plan',
    ...
    pluginsTab: 'Plugins',
    dshSettingsTitle: 'DeepSeek Harness',
    dshSettingsDesc: 'Bundles DeepSeek\'s official open-source agent framework (dsh). Once enabled, 百应\'s model provider configuration syncs into dsh automatically.',
    ...
    browserProfileManagedDescription:
      '百应 starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for 百应, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: '百应 will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means 百应 will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means 百应 can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow 百应 to send notifications in the system settings.',
    ...
    settingsNavGroupPreferences: 'Preferences',
    settingsNavGroupAgent: 'Agent',
    settingsNavGroupConnections: 'Connections',
    settingsNavGroupAbout: 'About',
    settingsNavSearchPlaceholder: 'Search settings…',
    settingsNavSearchEmpty: 'No matching settings',
