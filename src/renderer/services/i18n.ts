...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aboutFeedbackGroup: '问题反馈群',
    aboutFeedbackGroupHint: '点击查看大图；企业内部群，仅企业成员可扫码加入',
    aboutFeedbackGroupClickToPreview: '点击查看问题反馈群二维码',
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「BaiYing 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 BaiYing 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 BaiYing 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    codeFontSizeDescription: '调整聊天和代码视图中代码使用的基准字号',
    'theme-name-classic-light': '日间',
    'theme-name-classic-dark': '夜间',
    ...
    shortcutDescNewChat: '开始一个新的 BaiYing 任务',
    shortcutDescFocusPrompt: '跳回 BaiYing 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 BaiYing 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 BaiYing Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    enterpriseQuotaMemberMemberDesc: '向团队管理员申请提高成员额度后继续使用 BaiYing。',
    enterpriseQuotaMemberAdminDesc: '调整额度后继续使用 BaiYing。',
    ...
    enterpriseQuotaPoolMemberDesc: '通知团队管理员购买团队积分包后继续使用 BaiYing。',
    enterpriseQuotaPoolAdminDesc: '购买团队积分包后，团队成员可继续使用 BaiYing。',
    ...
    artifactPreviewCardLobsterBrowser: 'BaiYing',
    artifactPreviewCardOpenInLobsterBrowser: '在 BaiYing 中打开',
    ...
    coworkWorkingDirectoryHint: 'BaiYing 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 BaiYing 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 BaiYing 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'BaiYing 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 BaiYing 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 BaiYing 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 BaiYing 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 BaiYing 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'BaiYing 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'BaiYing 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkContextMaintenanceRunning: '正在整理桌上的上下文…',
    coworkModelResponseWaitingLong: '还在跟进，马上就有进展…',
    coworkWorkingStage0: '收到，我先理清你的需求…',
    coworkWorkingStage1: '正在翻资料、对齐上下文…',
    coworkWorkingStage2: '埋头处理中，马上就有进展…',
    coworkWorkingStage3: '还在跟进细节，再稍等片刻…',
    coworkWorkingStage4: '事情比预想复杂一点，我继续盯着…',
    coworkWorkingTool: '正在用 {tool} 帮你处理…',
    ...
    coworkWelcome: 'BaiYing',
    coworkDescription: '全场景办公助手 Agent',
    sidebarNavConversation: '对话',
    sidebarNavSkillsPlugins: '技能插件',
    ...
    coworkHomeHeroTitle: 'Hi, 我是{name}',
    coworkHomeHeroSubtitle: '随时随地，帮你完成工作',
    coworkHomeAgentManagement: 'Agent 管理',
    coworkHomeMobileRemote: '手机远程',
    coworkHomeTagline: '我是 BaiYing，你的全场景办公 Agent',
    ...
    coworkErrorModelSourceBaiYingPlan: 'BaiYing 套餐',
    ...
    dshSettingsDesc: '内置 DeepSeek 官方开源 agent 框架（dsh）。启用后，BaiYing 的模型供应商配置会自动同步给 dsh。',
    ...
    pluginsSaveFailed: '插件设置保存失败，请重试',
    ...
    browserWebAccessDescription: '使用 BaiYing 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'BaiYing 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为 BaiYing 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'BaiYing 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 BaiYing 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 BaiYing 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 BaiYing 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 BaiYing',
  ...
  en: {
    ...
    aboutFeedbackGroup: 'Feedback Group',
    aboutFeedbackGroupHint: 'Click to enlarge. Internal corporate group — members only',
    aboutFeedbackGroupClickToPreview: 'Click to preview feedback group QR code',
    ...
    aiSkinCreationGuide: 'Use “Customize BaiYing” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only BaiYing-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the BaiYing UI',
    codeFontSize: 'Code font size',
    codeFontSizeDescription: 'Adjust the base size used for code in chats and code views',
    'theme-name-classic-light': 'Day',
    'theme-name-classic-dark': 'Night',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the BaiYing window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutOpenCowork: 'Open BaiYing',
    ...
    shortcutDescNewChat: 'Start a new BaiYing task',
    shortcutDescFocusPrompt: 'Return to BaiYing and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the BaiYing task view',
    ...
    dailyCheckInLoginHint: 'Login is handled by BaiYing; the activity never receives account tokens',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit BaiYing Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    enterpriseQuotaMemberMemberDesc: 'Request a higher member quota from your team administrator to continue using BaiYing.',
    enterpriseQuotaMemberAdminDesc: 'Adjust your quota to continue using BaiYing.',
    ...
    enterpriseQuotaPoolMemberDesc: 'Notify your team administrator to purchase a Team credit pack and continue using BaiYing.',
    enterpriseQuotaPoolAdminDesc: 'Purchase a Team credit pack so members can continue using BaiYing.',
    ...
    siteQuotaChooseHint: 'Choose an online site. BaiYing will never stop one automatically.',
    ...
    artifactPreviewCardLobsterBrowser: 'BaiYing',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in BaiYing',
    ...
    // BaiYing
    cowork: 'BaiYing',
    coworkSettings: 'BaiYing Settings',
    ...
    coworkWorkingDirectoryHint: 'BaiYing will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for BaiYing...',
    coworkSystemPromptHint: "Optional system prompt to customize BaiYing's behavior",
    ...
    coworkModelSettingsHint:
      'BaiYing uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up BaiYing data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import BaiYing data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import BaiYing data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkConfigSaveFailed: 'Failed to save BaiYing settings. Please try again.',
    ...
    coworkPermissionDescription: 'BaiYing is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'BaiYing needs your input',
    ...
    coworkContextMaintenanceRunning: 'Tidying up the context on my desk…',
    coworkModelResponseWaitingLong: 'Still on it — progress coming shortly…',
    coworkWorkingStage0: 'Got it — lining up what you need…',
    coworkWorkingStage1: 'Checking notes and aligning context…',
    coworkWorkingStage2: 'Heads down on it — progress coming shortly…',
    coworkWorkingStage3: 'Still working through the details…',
    coworkWorkingStage4: 'Taking longer than expected — staying on it…',
    coworkWorkingTool: 'Working with {tool} for you…',
    ...
    sidebarNavConversation: 'Chat',
    sidebarNavSkillsPlugins: 'Skills',
    ...
    coworkHomeHeroTitle: 'Hi, I am {name}',
    coworkHomeHeroSubtitle: 'Anytime, anywhere, I help you get work done',
    coworkHomeAgentManagement: 'Agent Management',
    coworkHomeMobileRemote: 'Mobile Remote',
    coworkHomeTagline: "I'm BaiYing, your all-in-one office agent",
    ...
    coworkErrorModelSourceBaiYingPlan: 'BaiYing plan',
    ...
    pluginsTab: 'Plugins',
    dshSettingsTitle: 'DeepSeek Harness',
    dshSettingsDesc: 'Bundles DeepSeek\'s official open-source agent framework (dsh). Once enabled, BaiYing\'s model provider configuration syncs into dsh automatically.',
    ...
    pluginsSaveFailed: 'Failed to save plugin settings. Please try again.',
    ...
    browserWebAccessDescription: 'Use the BaiYing separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription:
      'BaiYing starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for BaiYing, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'BaiYing will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means BaiYing will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means BaiYing can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow BaiYing to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve BaiYing',
    usageAnalyticsEnabledDescription:
    ...
    welcomeTitle: 'Log in to BaiYing',
    ...
    welcomeAgreementLinkText: 'NetEase Youdao BaiYing Terms of Service',
