...
export const THEME_APPEARANCE_STORAGE_KEY = 'baiying-theme-appearance';
...
export interface ThemeManagerOptions {
  /** localStorage key for persistence. Default: 'baiying-theme' */
  storageKey?: string;
...
const THEME_TRANSITION_CLASS = 'baiying-theme-transition';
...
export class ThemeManager {
  ...
  constructor(themes: ThemeDefinition[], options: ThemeManagerOptions = {}) {
    ...
    this.opts = {
      storageKey: options.storageKey ?? 'baiying-theme',
