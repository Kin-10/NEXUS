...
//      BaiYing-owned instances, including stale locks from a hard kill;
...
export const DSH_WRITER_LOCK_FILE = '.baiying-dsh-writer.json';
...
export function probeStandaloneDsh(port = DSH_STANDALONE_DEFAULT_PORT): Promise<boolean> {
  return new Promise((resolve) => {
    const body = JSON.stringify({ type: 'client-request', rpcId: 'baiying-probe', method: 'host.describe', payload: {} });
