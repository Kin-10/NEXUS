...
// Canonical content of the BaiYing-generated pip shim and wrapper files for
...
// true for every historical BaiYing shim, never for a real pip package
...
/**
 * Converge BaiYing-owned pip shim/wrapper files to the current templates.
 *
