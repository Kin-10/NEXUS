...
用户从技能市场安装技能后（如 hzbnote v1.0.0），当市场发布新版本（v1.0.1）时，没有任何升级入口。技能市场仍显示"已安装"徽章，用户必须手动删除旧版本再重新安装才能获取更新。
...
**Given** 用户已安装 hzbnote v1.0.0
**When** 用户打开技能市场，市场中 hzbnote 已更新到 v1.0.1
