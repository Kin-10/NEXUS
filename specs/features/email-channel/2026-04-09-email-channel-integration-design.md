...
6. Session appears in BaiYing sidebar
...
7. User copies API Key and pastes into BaiYing input field
8. User clicks Save
...
- [ ] Reply in BaiYing → verify email sent via SMTP/WebSocket
...
No existing BaiYing features are affected:
...
**Goal:** Integrate the `@clawemail/email` OpenClaw plugin into BaiYing with full UI configuration support for IMAP/SMTP and WebSocket transport modes.
