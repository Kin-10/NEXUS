...
**When** 用户选择“派生到新工作树”  
**Then** BaiYing 创建新的 Git worktree
...
**When** 用户选择“派生到新工作树”  
**Then** BaiYing 提示未提交改动不会自动带入新工作树

**When** 用户确认继续  
**Then** BaiYing 基于 `HEAD` 创建 worktree

### 场景 4: worktree 创建失败

**Given** branch 名称冲突、路径已存在或 Git 命令失败  
**When** 用户选择“派生到新工作树”  
**Then** BaiYing 不创建新 Cowork session
