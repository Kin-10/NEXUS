...
```typescript
// Before:
managedConfig.channels.telegram = { enabled: true, botToken: '${baiying_TG_BOT_TOKEN}', ... };
...
- Bot tokens: `baiying_TG_BOT_TOKEN`, `baiying_TG_BOT_TOKEN_1`, ..., `baiying_TG_BOT_TOKEN_N`
- Webhook secrets: `baiying_TG_WEBHOOK_SECRET`, `baiying_TG_WEBHOOK_SECRET_1`, ..., `baiying_TG_WEBHOOK_SECRET_N`
