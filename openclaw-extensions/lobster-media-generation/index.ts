...
const MediaToolName = {
  ImageGenerate: 'baiying_image_generate',
  VideoGenerate: 'baiying_video_generate',
  SkinManage: 'baiying_skin_manage',
} as const;
...
const plugin = {
  ...
  description: 'Image/video generation and AI skin management tools powered by BaiYing.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      ...
      return {
        ...
        description: [
          'Generate images using BaiYing server.',
          'Supports text-to-image and image-to-image generation.',
          'If the system prompt includes a BaiYing media reference mapping, use mapped file paths or URLs in image/images arguments and never pass @ media tokens as tool argument values.',
    ...
    api.registerTool((ctx) => {
      ...
      return {
        ...
        description: [
          'Generate videos using BaiYing server.',
          ...
          'If the system prompt includes a BaiYing media reference mapping, use mapped file paths or URLs in image/images/firstFrame/referenceImages/video/videos/media arguments and never pass @ media tokens as tool argument values.',
    ...
    api.registerTool((ctx) => {
      ...
      return {
        ...
        description: [
          'Create and manage a BaiYing AI skin pack through the trusted desktop callback.',
          ...
          'BaiYing deterministically infers a preferred light or dark appearance from presentation colors and applies it through the existing theme system; do not choose a color theme ID.',
    ...
    api.logger.info('[lobster-media-generation] registered baiying_image_generate, baiying_video_generate, and baiying_skin_manage tools.');
  },
};
