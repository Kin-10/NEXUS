...
} from '../openclaw-extensions/baiying-model-compat/profileMapping';

describe('baiying-model-compat profile mapping', () => {
  test('keeps only exact valid model refs and known profiles in deterministic order', () => {
    expect(parseModelProfileMap({
      ...
      'custom_0/kimi-k3': BaiYingModelRuntimeProfile.MoonshotKimiK3,
      'custom_2/alias-k3': BaiYingModelRuntimeProfile.MoonshotKimiK3,
    });
  });
